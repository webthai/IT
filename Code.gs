...
var SHEET_DEFS = {
  ...
  EDC: ['ID', 'สาขา', 'อาคาร', 'ชั้น', 'แผนก', 'ตำแหน่งย่อย', 'TID', 'สำรอง', 'หมายเหตุ', 'อัปเดตล่าสุด'],
  Pinpad: ['ID', 'สาขา', 'อาคาร', 'ชั้น', 'แผนก', 'ตำแหน่งย่อย', 'Serial Number', 'สำรอง', 'หมายเหตุ', 'อัปเดตล่าสุด'],
