...
1.jpg        → ไอคอน/โลโก้เว็บ (อ้างอิงไว้ใน index.html) — เพิ่มไฟล์จริงเข้า repo แล้ว (2026-09-17) สี่เหลี่ยมมุมโค้ง สีเขียวอมฟ้า (--teal) ตัวอักษร "IT" สีขาว ตรงกับสไตล์ .mark ในหน้าเว็บ
